...
static void WashingMachine_LCD_Display(uint32_t remain_time);
...
printf("wash_mode_start_stop_flag: %d\n", wash_mode_start_stop_flag);
	...
	/************************BEGIN 기본 동작 부분************************/
	WashingMachine_LCD_Display(wash_remain_time);
...
printf("rinse_mode_start_stop_flag: %d\n", rinse_mode_start_stop_flag);
	...
	/************************BEGIN 기본 동작 부분************************/
	WashingMachine_LCD_Display(rinse_remain_time);
	close_WashingMachine_Lid();
...
printf("dcmotor_duty_cycle: %d\n", dcmotor_duty_cycle);
	...
	/************************BEGIN 기본 동작 부분************************/
	WashingMachine_LCD_Display(spin_remain_time);
	close_WashingMachine_Lid();
